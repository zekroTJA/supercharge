...
namespace Crawler
{
    ...
    //[System.Runtime.InteropServices.Guid("73CE588A-29BA-4BE9-B7B1-D9032168ABF0")]
    public class PointsCrawler
    {
        ...
        public async Task GetStats(bool addToLog = false)
        {
            ...
            {
                await GetUserStats(user, addToLog);
            }
        }
